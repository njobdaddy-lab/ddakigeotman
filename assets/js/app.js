...
function applyStitchHomeStage1(){
  ...
  css.id='nmdStitchStage1';css.rel='stylesheet';css.href='./assets/css/home-stitch.css?v=stage1fix3';document.head.appendChild(css);
  ...
  if(oldHero){oldHero.outerHTML=`<section class="nmd-hero">
    ...
    <div class="nmd-proof-desktop">
      <div class="nmd-proof-grid">
        <div class="nmd-proof-card before"><img src="./assets/examples/hero-before.svg?v=proof3" alt="원본 이미지"><span class="nmd-proof-label">ORIGINAL</span></div>
        <div class="nmd-proof-card after"><img src="./assets/examples/hero-after.svg?v=proof3" alt="수정 결과 이미지"><span class="nmd-proof-label">RESULT</span></div>
      </div>
    ...
    <div class="nmd-proof-mobile">
      <div class="nmd-compare-card">
        <div class="nmd-compare">
          <img src="./assets/examples/hero-before.svg?v=proof3" alt="원본 이미지">
          <img class="nmd-compare-after" src="./assets/examples/hero-after.svg?v=proof3" alt="수정 결과 이미지">
